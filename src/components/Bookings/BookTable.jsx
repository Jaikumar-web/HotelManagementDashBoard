...
export default function StickyHeadTable() {
  ...
  useEffect(() => {
    axios.get("http://localhost/hotelManagement/oliveApi/moonAllEntry.php").then((res) => {
      ...
      {bookings ? (
        <Card sx={{ minWidth: 900, p: 2 }}>
          <Autocomplete
            ...
            getOptionLabel={(bookings) => bookings.kot_total}
            sx={{ width: 300 }}
                ...
                <Table stickyHeader aria-label="sticky table">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="center">NoOfPersons</TableCell>
