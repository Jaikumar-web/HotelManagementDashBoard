...
function Card(props) {
  ...
  return(
    <div>
         <OliveCard param={props} />  
    </div>
  )
}else if(props.name === 'HotelKiara'){
  return(
    <div>
         <KiaraCard param={props} />  
    </div>
  )
...
function OliveCard({ param }) {
  const navigate = useNavigate();
  const ToCheck = (link) =>{
    console.log("Olive links>>>>>>>>>>>>>>>",link);

    switch (link) {
      case 'oliveBooking':
        navigate("/oliveBookTable")
        break;
      case 'oliveRooms':
        navigate("/oliveRooms")
        break;
      case 'oliveCheckin':
        navigate("/oliveCheckIn")
        break;
      case 'memberShip':
        navigate("/oliveMembers")
        break;
      case 'oliveCheckOut':
...
function KiaraCard({ param }) {
  const navigate = useNavigate();
  const ToCheck = (link) =>{
    console.log("Kiara links>>>>>>>>>>>>>>>",link);

    switch (link) {
      case 'kiaraBooking':
        navigate("/kiaraBookTable")
        break;
      case 'kiaraRooms':
        navigate("/kiaraRooms")
        break;
      case 'kiaraCheckin':
        navigate("/kiaraCheckIn")
        break;
      case 'memberShip':
        navigate("/kiaraMembers")
        break;
      case 'kiaraCheckOut':
        navigate("/kiaraCheckOut")
        break;
      default:
        alert("booking check");
    }
