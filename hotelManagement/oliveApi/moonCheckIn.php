...
$sql = "SELECT guest_name, check_in_date, room_no, booking_mode, no_of_person from hotelmoondatabase.all_entry where check_in_date = '2018-07-22'"; // Replace with your table name
