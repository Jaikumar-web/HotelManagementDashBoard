...
$sql = "SELECT guest_name, check_in_date, room_no, booking_mode, no_of_person from hotelmanagement.all_entry where check_in_date = '2023-08-07'"; // Replace with your table name
