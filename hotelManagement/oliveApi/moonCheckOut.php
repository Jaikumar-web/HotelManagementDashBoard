...
$sql = "SELECT guest_name, check_out_date, room_no, booking_mode, no_of_person from hotelmoondatabase.all_entry where check_out_date = '2023-10-01'"; // Replace with your table name
